...
# Define some regular expressions to standardise the different used formats
...
#defining some functions that we will use to extract the metadata and more importantly the features from the wav files
